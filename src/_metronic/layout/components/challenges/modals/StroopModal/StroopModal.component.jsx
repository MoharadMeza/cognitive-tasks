                        ...
                        <div className="container">
                            ...
                            <div className="row form-group mb-2">
                                ...
                                <div className="col ps-0">
                                    <input type="number" className="form-control" id="input1" min="20" placeholder={`پیشفرض : ${props.stroopModalSetting.time}`} />
                                </div>
                            </div>
                            <div className="row form-group mb-2">
                                <label htmlFor="input2" className="col-auto col-form-label" dir="ltr">  : (ms) ISI </label>
                                <div className="col ps-0">
                                    <input type="number" className="form-control" id="input2" min="20" placeholder={`پیشفرض : ${props.stroopModalSetting.isi}`} />
                                </div>
                            </div>
                            <div className="row form-group mb-2">
                                <label htmlFor="input3" className="col-auto col-form-label" dir="ltr">  : (ms) Fixed </label>
                                <div className="col ps-0">
                                    <input type="number" className="form-control" id="input3" min="20" placeholder={`پیشفرض : ${props.stroopModalSetting.fixed}`} />
                                </div>
                            </div>
                            <div className="row form-group mb-2">
                                <label htmlFor="input4" className="col-auto col-form-label"> تعداد محرک:</label>
                                <div className="col ps-0">
                                    <input type="number" className="form-control" id="input4" min="5" placeholder={`پیشفرض : ${props.stroopModalSetting.numbers}`} />
                                </div>
                            </div>
                            <div className="row form-group mb-2">
                                <label htmlFor="input5" className="col-auto col-form-label"> درصد ناهمخوان :</label>
                                <div className="col ps-0">
                                    <input type="number" className="form-control" id="input5" min="2" placeholder={`پیشفرض : ${props.stroopModalSetting.incongPercent}`} />
                                </div>
                            </div>
                            <div className="row form-group mb-2">
                                <label htmlFor="input6" className="col-auto col-form-label"> کلید رنگ قرمز:</label>
                                <div className="col ps-0">
                                    <input type="text" pattern="[a-zA-Z]+" className="form-control" id="input6" maxLength="1" placeholder={`پیشفرض : ${String.fromCharCode(props.stroopModalSetting.asciiCode[0].codeEs)} یا ${String.fromCharCode(props.stroopModalSetting.asciiCode[0].codeEc)}`} />
                                </div>
                            </div>
                            <div className="row form-group mb-2">
                                <label htmlFor="input7" className="col-auto col-form-label"> کلید رنگ آبی:</label>
                                <div className="col ps-0">
                                    <input type="text" pattern="[a-zA-Z]+" className="form-control" id="input7" maxLength="1" placeholder={`پیشفرض : ${String.fromCharCode(props.stroopModalSetting.asciiCode[1].codeEs)} یا ${String.fromCharCode(props.stroopModalSetting.asciiCode[1].codeEc)}`} />
                                </div>
                            </div>
                            <div className="row form-group mb-2">
                                <label htmlFor="input8" className="col-auto col-form-label"> کلید رنگ زرد:</label>
                                <div className="col ps-0">
                                    <input type="text" pattern="[a-zA-Z]+" className="form-control" id="input8" maxLength="1" placeholder={`پیشفرض : ${String.fromCharCode(props.stroopModalSetting.asciiCode[2].codeEs)} یا ${String.fromCharCode(props.stroopModalSetting.asciiCode[2].codeEc)}`} />
                                </div>
                            </div>
                            <div className="row form-group mb-2">
                                <label htmlFor="input9" className="col-auto col-form-label"> کلید رنگ سبز:</label>
                                <div className="col ps-0">
                                    <input type="text" pattern="[a-zA-Z]+" className="form-control" id="input9" maxLength="1" placeholder={`پیشفرض : ${String.fromCharCode(props.stroopModalSetting.asciiCode[3].codeEs)} یا ${String.fromCharCode(props.stroopModalSetting.asciiCode[3].codeEc)}`} />
                                </div>
                            </div>
                            <div className="row form-group mb-2">
                                <div className="col">
